  ...
  #      print("prev states = {}".format(self.prev_states))
   ...
   #     print("\nstart planning: ")
     ...
     #       print("a = {}".format(a))
            ...
            r_new, s_new_row, s_new_col = self.model[s[0]][s[1]][a]
    #        print("r_new = {}, s_new_row = {}, s_new_col = {}".format(r_new, s_new_row, s_new_col))
            
            # update Q
            temp = r_new + self.gamma * max(self.Q[s_new_row][s_new_col])
            self.Q[s[0]][s[1]][a] += self.alpha * (temp - self.Q[s[0]][s[1]][a])
   ...
   #         print("greedy")
            ...
            ##new_action = self.argmax(self.Q[self.state[0]][self.state[1]]) # update self.action
